...
<head>
    ...
    <title>Testimonials Carousel || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Testimonials Carousel</h2><!-- /.page-title -->
        ...
        <section class="testimonials-one testimonials-one--page">
            <div class="container">
                <div class="testimonials-one__carousel ienet-owl__carousel ienet-owl__carousel--with-shadow ienet-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="testimonials-card__author">
                                <img src="assets/images/resources/testi-1-4.jpg" alt="Martin Guptil">
                                <h3 class="testimonials-card__name">
                                    Martin Guptil
                                </h3><!-- /.testimonials-card__name -->
