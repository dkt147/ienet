...
<head>
    ...
    <title>Fast Internet & Cyber Security || Services Details || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Fast Internet & Cyber Security</h2><!-- /.page-title -->
                <ul class="ienet-breadcrumb list-unstyled">
                    <li><a href="index.php">Home</a></li>
                    <li>Our Services</li>
                    <li><span>Fast Internet & Cyber Security</span></li>
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__thumbnail">
                                <img src="assets/images/resources/service-d-3.jpg" alt="Fast Internet & Cyber Security Activation">
                            </div><!-- /.service-details__thumbnail -->
                            <h3 class="service-details__title">Fast Internet & Cyber Security Activation</h3><!-- /.service-details__title -->
                            <p class="service-details__text">
                                ...
                                sollicitudin dolor. In ut hendrerit ipsum.
                            </p>
                            ...
                            <h3 class="service-details__title">Benefit of This Service</h3><!-- /.service-details__title -->
                            <p class="service-details__text">
                                onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar. Pellentesque sit amet luctus ante, ut elementum nisl.
                                Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur elit leo. Curabitur pellentesque ultrices odio eu pellentesque.
                                Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin
                            ...
                            <h3 class="service-details__title">FAQ On This Service</h3><!-- /.service-details__title -->
                            <p class="service-details__text">
                                onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar. Pellentesque sit amet luctus ante, ut elementum nisl.
                                Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur elit leo. Curabitur pellentesque ultrices odio eu pellentesque.
                                Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin
                        ...
                        <div class="service-sidebar">
                            <div class="service-sidebar__single">
                                <ul class="list-unstyled service-sidebar__nav">
                                    <li><a href="service-d-broadband.php">Fiber Line & Broadband Line</a></li>
                                    <li><a href="service-d-iptv.php">Fiber Line With Smart IPTV</a></li>
                                    <li><a href="service-d-cyber-security.php">Fast Internet & Cyber Security</a></li>
                                    <li><a href="service-d-landline.php">Optical Fiber & Landline</a></li>
                                    <li><a href="service-d-tv.php">Amazon Fire Stick Box TV</a></li>
                                    <li><a href="service-d-connectivity.php">Smart Data Connectivity Line</a></li>
                                </ul><!-- /.list-unstyled service-sidebar__nav -->
                            </div><!-- /.service-sidebar__single -->
                            <div class="service-sidebar__single ">
                                <div class="service-sidebar__contact text-center" style="background-image: url(assets/images/backgrounds/service-contact-bg-1.jpg);">
                                    ...
                                    <p class="service-sidebar__contact__number">
                                        ...
                                        <a href="tel:+88012365499">+258 84 9903997</a>
