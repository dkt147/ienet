...
<head>
    ...
    <title>Hi Speed Digital Router || Products Details || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Hi Speed Digital Router</h2><!-- /.page-title -->
                <ul class="ienet-breadcrumb list-unstyled">
                    <li><a href="index.php">Home</a></li>
                    <li>Our Shop</li>
                    <li><span>Hi Speed Digital Router</span></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="product-details__img">
                            <img src="assets/images/products/product-d-1-1.jpg" alt="ienet">
                        </div>
                    </div><!-- /.column -->
                    <div class="col-lg-6 col-xl-6 d-flex align-items-center wow fadeInRight" data-wow-delay="300ms">
                        <div class="product-details__content">
                            <div class="product-details__top">
                                <h3 class="product-details__title">Hi Speed Digital Router</h3><!-- /.product-title -->
                                <div class="product-details__price">$69</div><!-- /.product-price -->
                            </div>
                            <div class="product-details__review">
                                <span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>
                                <a href="product-details.php">(3 customer reviews)</a>
                            </div><!-- /.review-ratings -->
                            <div class="product-details__divider"></div><!-- /.divider -->
                            <div class="product-details__excerpt">
                                <p class="product-details__excerpt__text">
                                    Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo venenatis ligula commodo leez sed
                            ...
                            <div class="product-details__quantity">
                                ...
                                <div class="quantity-box">
                                    ...
                                    <input type="text" id="1" value="02">
                                    <button type="button" class="add"><i class="fa fa-plus"></i></button>
                                </div>
                            </div><!-- /.quantity -->
                            <div class="product-details__buttons">
                                <a href="cart.php" class="ienet-btn product-details__buttons__cart"><span>Add To Cart<span class="ienet-btn__icon"><i class="icon-cart"></i></span></span></a>
                                <a href="checkout.php" class="ienet-btn product-details__buttons__wishlist"><span>Add to Wishlist</span></a>
                            </div><!-- /.qty-btn -->
                ...
                <div class="product-details__description wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <p class="product-details__description__text">
                        ...
                        centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Aelltes port lacus quis enim var
                        sed efficitur turpis gilla sed sit <br>amet finibus eros. Neque porro est qui dolorem ipsum quia quaed inventor veritatis et
                        quasi architecto beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet
                ...
                <div class="product-details__comment wow fadeInUp" data-wow-delay="400ms">
                    <h3 class="product-details__review-title">02 Reviews, ecolimn</h3>
                    <!--Start Comment Box-->
                    <div class="product-details__comment-box">
                        <figure class="product-details__comment-box__thumb"><img src="assets/images/products/product-c-1-1.jpg" alt="ienet"></figure><!-- comment-image -->
                        <div class="product-details__comment-box__content">
                            <h4 class="product-details__comment-box__name">Kevin Martin</h4>
                            <span class="product-details__comment-box__date">March 20, 2023 at 2:37 pm</span>
                            <!-- comment-meta -->
                    ...
                    <!--Start Comment Box-->
                    <div class="product-details__comment-box">
                        <figure class="product-details__comment-box__thumb"><img src="assets/images/products/product-c-1-2.jpg" alt="ienet"></figure><!-- comment-image -->
                        <div class="product-details__comment-box__content">
                            <h4 class="product-details__comment-box__name">Sarah Albert</h4>
                            <span class="product-details__comment-box__date">March 20, 2023 at 2:37 pm</span>
                            <!-- comment-meta -->
                            <div class="product-details__comment-box__ratings">
                                <span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>
                ...
                <div class="product-details__form wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <p class="product-details__form-text">Your email address will not be published. Required fields are marked *</p>
