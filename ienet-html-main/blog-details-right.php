...
<head>
    ...
    <title>There Are Many Variations || Blog Details || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">There Are Many Variations</h2><!-- /.page-title -->
                <ul class="ienet-breadcrumb list-unstyled">
                    <li><a href="index.php">Home</a></li>
                    <li>Blog Details</li>
                    <li><span>There Are Many Variations</span></li>
                    ...
                    <div class="col-lg-8">
                        <div class="blog-details__content">
                            <div class="blog-details__image">
                                <img src="assets/images/blog/blog-details-1-1.jpg" alt="ienet">
                                <div class="blog-details__image__date">AUG, 04</div>
                            </div><!-- /.blog-card__image -->
                            <ul class="list-unstyled blog-details__top-meta">
                                <li><a href="blog-list-right.php"><i class="fas fa-user-alt"></i>by Admin</a></li>
                                <li><i class="fas fa-comment-dots"></i>2 Comments</li>
                            </ul><!-- /.list-unstyled blog-card__top-meta -->
                            <h3 class="blog-details__title">There Are Many Variations of Passages of Available But Majority</h3>
                            ...
                            <p class="blog-details__text">
                                ...
                                five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Aelltes port
                                lacus quis enim var sed efficitur
                            </p><!-- /.blog-details__text -->
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="blog-details__content__image">
                                        <img src="assets/images/blog/blog-details-1-2.jpg" alt="ienet">
                                    </div><!-- /.service-details__image -->
                                </div><!-- /.col-md-6 -->
                                <div class="col-md-6">
                                    <div class="blog-details__content__image">
                                        <img src="assets/images/blog/blog-details-1-3.jpg" alt="ienet">
                                    </div><!-- /.service-details__image -->
                                </div><!-- /.col-md-6 -->
                            </div>
                            <p class="blog-details__text">
                            ...
                            <ul class="list-unstyled blog-details__list">
                                ...
                                <li>AI also has the potential to improve healthcare, by enabling more accurate diagnosis and</li>
                            ...
                            <div class="blog-details__meta">
                                <div class="blog-details__cats">
                                    ...
                                    <a href="blog-list-right.php">Broadband</a>
                                    <a href="blog-list-right.php">Innovations</a>
                            ...
                            <ul class="list-unstyled comments-one__list">
                                <li class="comments-one__card">
                                    <div class="comments-one__card__image">
                                        <img src="assets/images/blog/blog-comment-1-1.jpg" alt="ienet">
                                    ...
                                    <div class="comments-one__card__content">
                                        ...
                                        <span class="comments-one__card__date">March 20, 2023 at 2:37 pm</span><!-- /.comments-one__card__date -->
                                        <p class="comments-one__card__text">
                                            Neque porro est qui dolorem ipsum quia quaed inventor veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                                            Aelltes port lacus quis enim var
                                        </p><!-- /.comments-one__card__text -->
                                        <div class="comments-one__card__btn">
                                            <a href="blog-details-right.php" class="ienet-btn comments-one__card__reply"><span>Reply</span></a>
                                        </div><!-- /.comments-one__card__btn -->
                                    </div><!-- /.comments-one__card__content -->
                                </li><!-- /.comments-one__card -->
                                <li class="comments-one__card">
                                    <div class="comments-one__card__image">
                                        <img src="assets/images/blog/blog-comment-1-2.jpg" alt="ienet">
                                    </div><!-- /.comments-one__card__image -->
                                    <div class="comments-one__card__content">
                        ...
                        <div class="comments-form">
                            ...
                            <form class="comments-form__form contact-form-validated form-one">
                                <div class="form-one__group">
                                    ...
                                    <div class="form-one__control form-one__control--full">
                                        <button type="submit" class="ienet-btn ienet-btn--base"><span>Submit comment</span></button>
                                    </div><!-- /.form-one__control -->
                                </div><!-- /.form-one__group -->
                            </form>
