                ...
                <div class="row">
                        ...
                        <ul class="list-unstyled contact-one__info">
                            <li class="contact-one__info__item">
                                ...
                                <div class="contact-one__info__content">
                                    ...
                                    <p class="contact-one__info__text">901 N Pitt Str., Suite 170 <br>Alexandria, USA</p><!-- /.contact-one__info__text -->
                    ...
                    <div class="col-xl-8">
                        <form class="contact-one__form contact-form-validated form-one wow fadeInUp" data-wow-duration="1500ms" action="inc/sendemail.php">
                            <div class="contact-one__form__bg" style="background-image: url(assets/images/shapes/contact-bg-1.png);"></div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-one__group">
                                        ...
                                        <div class="form-one__control form-one__control--full">
                                            <button type="submit" class="ienet-btn"><span>Get In Touch<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></button>
                                        </div><!-- /.form-one__control -->
                                    </div><!-- /.form-one__group -->
                                </div>
                            </div>
