...
<head>
    ...
    <title>Team Carousel || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Team Carousel</h2><!-- /.page-title -->
        ...
        <section class="team-one">
            <div class="container">
                <div class="team-one__carousel ienet-owl__carousel ienet-owl__carousel--with-shadow ienet-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 0,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="team-one__item wow fadeInUp" data-wow-delay="00ms" style="--accent-color: #DF2339;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-1.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-1.png" alt="ienet">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Andrey Khusid</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">CEO and Co-founder</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--two wow fadeInUp" data-wow-delay="50ms" style="--accent-color: #FEBE57;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-2.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-2.png" alt="ienet">
                            </div><!-- /.team-one__item__image -->
                            <div class="team-one__item__content">
                                <div class="team-one__item__social">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Anna Boyarkina</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Head of Product</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--three wow fadeInUp" data-wow-delay="100ms" style="--accent-color: #FF651F;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-3.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-3.png" alt="ienet">
                            </div><!-- /.team-one__item__image -->
                            <div class="team-one__item__content">
                                <div class="team-one__item__social">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Eliana D Cruz</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Manager</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--four wow fadeInUp" data-wow-delay="150ms" style="--accent-color: #4FA9C6;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-4.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-4.png" alt="ienet">
                            </div><!-- /.team-one__item__image -->
                            <div class="team-one__item__content">
                                <div class="team-one__item__social">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Ronald C. Clark</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">CEO and Co-founder</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    ...
                    <div class="item">
                        <div class="team-one__item team-one__item--five wow fadeInUp" data-wow-delay="200ms" style="--accent-color: #F1CB40;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-5.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-5.png" alt="ienet">
                            </div><!-- /.team-one__item__image -->
                            <div class="team-one__item__content">
                                <div class="team-one__item__social">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Ella L. Albers</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Head of Product</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    ...
                    <div class="item">
                        <div class="team-one__item team-one__item--six wow fadeInUp" data-wow-delay="250ms" style="--accent-color: #E4E8EF;">
                            <div class="team-one__item__shape" style="background-image: url(assets/images/shapes/team-1-shape-6.png);"></div>
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-6.png" alt="ienet">
                            </div><!-- /.team-one__item__image -->
                            <div class="team-one__item__content">
                                <div class="team-one__item__social">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details.php">Ben D. Reno</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Manager</p><!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
