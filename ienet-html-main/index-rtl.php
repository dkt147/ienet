...
<head>
    ...
    <title>Home RTL || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="assets/css/ienet-rtl.css" />
    <link rel="stylesheet" href="assets/css/ienet-custom-rtl.css" />
    <link rel="stylesheet" href="assets/vendors/ienet-toolbar/css/ienet-toolbar.css">
</head>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                                                ...
                                                <div class="home-showcase__inner">
                                                    <div class="row">
                                                        <div class="col-md-6 col-lg-3">
                                                            <div class="demo-one__card">
                                                                <div class="demo-one__image">
                                                                    <img src="assets/images/home-showcase/home-showcase-1.jpg" alt="ienet">
                                                        ...
                                                        <div class="col-md-6 col-lg-3">
                                                            <div class="demo-one__card">
                                                                <div class="demo-one__image">
                                                                    <img src="assets/images/home-showcase/home-showcase-2.jpg" alt="ienet">
                                                                    <div class="demo-one__btns">
                                                        ...
                                                        <div class="col-md-6 col-lg-3">
                                                            <div class="demo-one__card">
                                                                <div class="demo-one__image">
                                                                    <img src="assets/images/home-showcase/home-showcase-3.jpg" alt="ienet">
                                                                    <div class="demo-one__btns">
                                                        ...
                                                        <div class="col-md-6 col-lg-3">
                                                            <div class="demo-one__card">
                                                                <div class="demo-one__image">
                                                                    <img src="assets/images/home-showcase/home-showcase-4.jpg" alt="ienet">
                                                                    <div class="demo-one__btns">
                    ...
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__btn">
                                <a href="services.php" class="ienet-btn main-slider-one__btn__first"><span>our service<span class="ienet-btn__icon"><i class="fas fa-chevron-left"></i></span></span></a><!-- slider-btn -->
                        ...
                        <div class="main-slider-one__layer" style="background-image: url(assets/images/backgrounds/slider-1-layer-1-rtl.png);"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__layer" style="background-image: url(assets/images/backgrounds/slider-1-layer-2-rtl.png);"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__layer" style="background-image: url(assets/images/backgrounds/slider-1-layer-3-rtl.png);"></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="about-one" style="background-image: url(assets/images/shapes/about-1-bg.png);">
            <div class="about-one__shape" style="background-image: url(assets/images/resources/about-shape-1-rtl.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                            ...
                            <div class="about-one__image__two">
                                <div class="about-one__image__two__inner"><img src="assets/images/resources/about-1-2.jpg" alt="ienet"></div>
                            </div>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="about-one__content">
                            ...
                            <a href="about.php" class="ienet-btn"><span>More About Us<span class="ienet-btn__icon"><i class="fas fa-chevron-left"></i></span></span></a>
        ...
        <section class="packages-one">
            ...
            <div class="container tabs-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="packages.php" class="ienet-btn"><span>View All Service<span class="ienet-btn__icon"><i class="fas fa-chevron-left"></i></span></span></a>
                    </div>
                </div>
                        ...
                        <div class="row gutter-y-30">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="packages-one__card">
                                    ...
                                    <a class="packages-one__card__rm" href="contact.php"><i class="icon-right-chevron"></i></a>
                                    <div class="packages-one__card__image">
                                        <img src="assets/images/resources/package-1-2.jpg" alt="ienet">
                                    </div>
                                </div>
                            </div><!-- item -->
                            <div class="col-lg-4 col-md-6">
                                <div class="packages-one__card">
                                    ...
                                    <a class="packages-one__card__rm" href="contact.php"><i class="icon-right-chevron"></i></a>
                                    <div class="packages-one__card__image">
                                        <img src="assets/images/resources/package-1-3.jpg" alt="ienet">
                                    </div>
                                </div>
                            </div><!-- item -->
                        </div>
        ...
        <section class="mail-one">
            ...
            <!-- /.movie-one__bg -->
            <div class="mail-one__shape-left" style="background-image: url(assets/images/resources/mail-shape-1-rtl.png);"></div>
            <div class="mail-one__shape-right" style="background-image: url(assets/images/resources/mail-shape-2-rtl.png);"></div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="00ms">
                        <div class="cta-one__content">
                            ...
                            <a href="about.php" class="ienet-btn"><span>Get In Touch<span class="ienet-btn__icon"><i class="fas fa-chevron-left"></i></span></span></a>
                        </div>
                    </div>
                </div>
            </div><!-- /.container -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="movie-one__nav">
                            <a href="#" class="movie-one__nav__prev"><i class="icon-right-chevron"></i></a>
                            <a href="#" class="movie-one__nav__next"><i class="icon-left-chevron"></i></a>
		...
		"responsive": {
			...
			"1800": {
                ...
                <div class="item">
                    <div class="movie-one__item">
                        <div class="movie-one__item__image">
                            <img src="assets/images/movie/movie-1-4.jpg" alt="ienet">
                        </div>
                        <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="video-popup">
                            <i class="fa fa-play"></i>
                            <i class="ripple"></i>
                ...
                <div class="item">
                    <div class="movie-one__item">
                        <div class="movie-one__item__image">
                            <img src="assets/images/movie/movie-1-5.jpg" alt="ienet">
                        </div>
                        <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="video-popup">
                            <i class="fa fa-play"></i>
                            <i class="ripple"></i>
                ...
                <div class="item">
                    <div class="movie-one__item">
                        <div class="movie-one__item__image">
                            <img src="assets/images/movie/movie-1-6.jpg" alt="ienet">
                        </div>
                        <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="video-popup">
                            <i class="fa fa-play"></i>
                            <i class="ripple"></i>
                ...
                <div class="item">
                    <div class="movie-one__item">
                        <div class="movie-one__item__image">
                            <img src="assets/images/movie/movie-1-7.jpg" alt="ienet">
                        </div>
                        <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="video-popup">
                            <i class="fa fa-play"></i>
                            <i class="ripple"></i>
        ...
        <section class="testimonials-one">
            ...
            <div class="testimonials-one__image" style="background-image: url(assets/images/resources/testimonial-image-1.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="testimonials-one__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-left">What Peoples <span>Talked</span> About Us</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            ...
                            <div class="testimonials-one__nav">
                                <a href="#" class="testimonials-one__nav__prev"><i class="icon-right-chevron"></i></a>
                                <a href="#" class="testimonials-one__nav__next"><i class="icon-left-chevron"></i></a>
                            </div><!-- /.testimonials-one__custome-navs -->
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="ienet-stretch-element-inside-column">
                            <div class="testimonials-one__carousel ienet-owl__carousel ienet-owl__carousel--custom-nav owl-theme owl-carousel" data-owl-nav-prev=".testimonials-one__nav__prev" data-owl-nav-next=".testimonials-one__nav__next" data-owl-options='{
						"items": 1,
						"margin": 30,
						"smartSpeed": 700,
						"loop":true,
                                ...
                                <div class="item">
                                    <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                        ...
                                        <div class="testimonials-card__author">
                                            ...
                                            <p class="testimonials-card__designation">managing director</p><!-- /.testimonials-card__designation -->
    ...
    <!-- toolbar js -->
    <script src="assets/vendors/ienet-toolbar/js/js.cookie.min.js"></script>
    <script src="assets/vendors/ienet-toolbar/js/jQuery.style.switcher.min.js"></script>
    <script src="assets/vendors/ienet-toolbar/js/lang.js"></script>
    <script src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    <script src="assets/vendors/ienet-toolbar/js/ienet-toolbar.js"></script>
