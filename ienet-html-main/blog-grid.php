...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Blog Grid No Sidebar</h2><!-- /.page-title -->
            ...
            <div class="container">
                <div class="row gutter-y-30">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__image">
                                <img src="assets/images/blog/blog-1-9.png" alt="There are Several Types of Connections Available">
                                <img src="assets/images/blog/blog-1-9.png" alt="There are Several Types of Connections Available">
                                <a href="blog-details-right.php" class="blog-card__image__link"><span class="sr-only">There are Several Types of Connections Available</span>
                                    <!-- /.sr-only --></a>
                                <div class="blog-card__date">AUG, 04</div><!-- /.blog-card__date -->
                                <ul class="list-unstyled blog-card__meta">
                                    <li><a href="blog-list-right.php"><i class="fas fa-user-alt"></i>by Admin</a></li>
                            ...
                            <div class="blog-card__content">
                                <h3 class="blog-card__title"><a href="blog-details-right.php">There are Several Types of Connections Available</a></h3><!-- /.blog-card__title -->
                                <a href="blog-details-right.php" class="blog-card__link">
                                    <span class="blog-card__link__front"><span class="fas fa-angle-double-right"></span></span>
                                    <span class="blog-card__link__back"><span class="fas fa-angle-double-right"></span>Read More</span>
                                </a><!-- /.blog-card__link -->
