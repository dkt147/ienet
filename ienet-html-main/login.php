...
<head>
    ...
    <title>Login || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Log In</h2><!-- /.page-title -->
        ...
        <section class="login-page">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 wow wow fadeInLeft" data-wow-delay="100ms">
                        ...
                        <div class="login-page__wrap">
                            ...
                            <form class="login-page__form">
                                ...
                                <div class="login-page__form-btn-box">
                                    ...
                                    <a href="login.php" class="ienet-btn login-page__form-btn-box__google"><span><img src="assets/images/shapes/google.png" alt="ienet">Or sign in with Google</span></a>
                                    <p class="login-page__form-btn-box__register-text">Don’t have an account? <a href="login.php">Sign up now</a></p>
                                </div>
                            </form>
                        </div><!-- register-form -->
                    </div>
