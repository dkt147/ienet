...
<head>
    ...
    <title>Services Page || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Our Services</h2><!-- /.page-title -->
        ...
        <section class="service-page">
            <div class="container">
                <div class="service-page__carousel ienet-owl__carousel ienet-owl__carousel--with-shadow ienet-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-broadband.php">Fiber Line & Broadband Line</a></h3>
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-iptv.php">Fiber Line With Smart IPTV</a></h3>
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-cyber-security.php">Fast Internet & Cyber Security</a></h3>
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-landline.php">Optical Fiber & Landline</a></h3>
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-tv.php">Amazon Fire Stick Box TV</a></h3>
                    ...
                    <div class="item">
                        <div class="service-page__item">
                            ...
                            <div class="service-page__item__content">
                                <h3 class="service-page__item__title"><a href="service-d-connectivity.php">Smart Data Connectivity Line</a></h3>
                                <div class="service-page__item__icon"><span class="icon-optical-fiber"></span></div>
                            </div>
                        </div>
                    </div><!-- item -->
