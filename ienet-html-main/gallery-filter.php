...
<head>
    ...
    <title>Gallery Filter || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Gallery Filter</h2><!-- /.page-title -->
            ...
            <div class="container">
                <div class="text-center">
                    <ul class="list-unstyled post-filter gallery-one__filter__list">
                        ...
                        <li data-filter=".internet"><span>Internet</span></li>
                        <li data-filter=".broadband"><span>Broadband</span></li>
                        <li data-filter=".tv"><span>TV</span></li>
                        <li data-filter=".andoid"><span>Andoid</span></li>
                    </ul><!-- /.list-unstyledf -->
                </div><!-- /.text-center -->
                <div class="row gutter-y-30 masonry-layout filter-layout">
                    <div class="col-md-6 col-lg-4 filter-item broadband">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-1.jpg" alt="ienet">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item andoid internet">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-2.jpg" alt="ienet">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item internet broadband">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-3.jpg" alt="ienet">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-8 filter-item andoid broadband">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-4.jpg" alt="ienet">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item tv">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-5.jpg" alt="ienet">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-8 filter-item tv internet">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-6.jpg" alt="ienet">
                            <div class="gallery-one__card__hover">
