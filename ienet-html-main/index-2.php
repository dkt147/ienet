...
<head>
    ...
    <title>Home Two || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-slider-two__item">
                        ...
                        <div class="main-slider-two__content">
                            ...
                            <div class="main-slider-two__btn">
                                <a href="services.php" class="ienet-btn"><span>our service<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></a><!-- slider-btn -->
                            </div>
                        </div><!-- slider-content -->
                        ...
                        <div class="main-slider-two__price">start form<br> <span>$39 /</span> month</div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="00ms">
                        <a href="packages.php" class="ienet-btn packages-two__btn"><span>View All Service<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></a>
                    </div>
                </div>
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                        <div class="packages-two__card">
                            <div class="packages-two__card__inner">
                                ...
                                <a class="packages-two__card__rm" href="contact.php"><i class="icon-right-chevron"></i></a>
                            </div>
                        </div>
                    </div><!-- item -->
        ...
        <!-- Feature Start -->
        <section class="feature-one feature-one--home-two">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-one__image">
                            <div class="feature-one__image__one">
                                <img src="assets/images/resources/feature-1-2.jpg" alt="ienet">
                            </div>
                            <div class="feature-one__image__border">
                                <img src="assets/images/shapes/feature-shape-2.png" alt="ienet">
                            </div>
                        </div>
                    </div>
        ...
        <section class="faq-one faq-one--home-two">
            <div class="faq-one__shape" style="background-image: url(assets/images/shapes/faq-shape-2.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        </div><!-- /.testimonials-two__custome-navs -->
                    </div>
                </div>
            </div>
				...
				"dots":false
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 d-flex align-items-center">
                                    <div class="testimonials-two__thumb">
                                        <img src="assets/images/resources/testi-2-1.jpg" alt="ienet">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.item -->
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-lg-5 d-flex align-items-center">
                                    <div class="testimonials-two__thumb">
                                        <img src="assets/images/resources/testi-2-2.jpg" alt="ienet">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.item -->
        ...
        <section class="blog-two">
            <div class="blog-two__bg" style="background-image: url(assets/images/shapes/blog-bg-2.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 d-flex align-items-center">
                        <div class="blog-two__content">
                            ...
                            <a href="blog-list-right.php" class="ienet-btn"><span>View All Blog<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></a>
                        </div>
                    </div>
                    <div class="col-xl-8">
