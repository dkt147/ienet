                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="cart-page__table__meta">
                                        ...
                                        <h3 class="cart-page__table__meta-title"><a href="product-details.php">Hi-Speed Router</a>
                                        </h3>
                                    </div>
                                </td>
                                <td>$15.00</td>
                                ...
                                <td>$30.00</td>
                                <td>
                                    <a href="cart.php" class="table cart-page__table__remove">x</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="cart-page__table__meta">
                                        <div class="cart-page__table__meta-img">
                                            <img src="assets/images/products/cart-1-2.jpg" alt="ienet">
                                        </div>
                                        <h3 class="cart-page__table__meta-title"><a href="product-details.php">Voice Mic</a>
                                        </h3>
                                    </div>
                                </td>
                                <td>$15.00</td>
                            ...
                            <tr>
                                <td>
                                    <div class="cart-page__table__meta">
                                        <div class="cart-page__table__meta-img">
                                            <img src="assets/images/products/cart-1-3.jpg" alt="ienet">
                                        </div>
                                        <h3 class="cart-page__table__meta-title"><a href="product-details.php">Hifi VR Gadget</a>
                                        </h3>
                                    </div>
                                </td>
                                <td>$15.00</td>
                            ...
                            <tr>
                                <td>
                                    <div class="cart-page__table__meta">
                                        <div class="cart-page__table__meta-img">
                                            <img src="assets/images/products/cart-1-4.jpg" alt="ienet">
                                        </div>
                                        <h3 class="cart-page__table__meta-title"><a href="product-details.php">Water Softeners</a>
                                        </h3>
                                    </div>
                                </td>
                                <td>$15.00</td>
