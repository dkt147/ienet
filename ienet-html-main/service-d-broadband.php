...
<head>
    ...
    <title>Fiber Line & Broadband Line || Services Details || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Fiber Line & Broadband Line</h2><!-- /.page-title -->
                <ul class="ienet-breadcrumb list-unstyled">
                    <li><a href="index.php">Home</a></li>
                    <li>Our Services</li>
                    <li><span>Fiber Line & Broadband Line</span></li>
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__thumbnail">
                                <img src="assets/images/resources/service-d-1.jpg" alt="Fiber Line & Broadband Line Activation">
                            </div><!-- /.service-details__thumbnail -->
                            <h3 class="service-details__title">Fiber Line & Broadband Line Activation</h3><!-- /.service-details__title -->
