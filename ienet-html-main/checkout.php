...
<head>
    ...
    <title>Checkout || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                                ...
                                <div class="row bs-gutter-x-30">
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <input type="text" id="first_name" name="first_name" value="" placeholder="" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            <label for="last_name">last Name *</label>
                                            <input type="text" id="last_name" name="last_name" value="" placeholder="" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <select class="selectpicker" id="country" aria-label="Default select example">
                                                <option selected="">United state america</option>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <input type="text" id="address_one" name="address_one" value="" placeholder="1837 E Homer M Adams Pkwy" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            <label for="address_two">Address 2 *</label>
                                            <input type="text" id="address_two" name="address_two" value="" placeholder="1837 E Homer M Adams Pkwy" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            <label for="state">City or town</label>
                                            <input type="text" id="state" name="state" value="" placeholder="city or town" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            <label for="country_area">select area</label>
                                            <select class="selectpicker" id="country_area" aria-label="Default select example">
                                                <option selected="">georgia</option>
                                                <option value="1">Newyork</option>
                                                <option value="2">Florida</option>
                                                <option value="3">Sikago</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <input id="zipcode" name="zipcode" type="text" pattern="[0-9]*" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            <label for="phone">Phone *</label>
                                            <input id="phone" name="phone" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="checkout-page__input-box">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="checkout-page__shipping-address">
                            <h2 class="checkout-page__shipping-address__title">Ship to a different address</h2>
                            <form class="checkout-page__form">
                                <div class="checkout-page__input-box">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <table class="checkout-page__order-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro__title">plumbing pipe</td>
                                        <td class="pro__price">$15.00</td>
                                    </tr>
                                    <tr>
                                        <td class="pro__title">sub total</td>
                                        <td class="pro__price">$15.00</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="checkout-page__payment">
                                <div class="checkout-page__payment__item checkout-page__payment__item--active">
                                    ...
                                    <div class="checkout-page__payment__content" style="display: none;">
                                        ...
                                        vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur
                                ...
                                <div class="checkout-page__payment__btn">
                                    <a href="checkout.php" class="ienet-btn">
