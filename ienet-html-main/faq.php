...
<head>
    ...
    <title>Faq Page || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">FAQ</h2><!-- /.page-title -->
        ...
        <section class="faq-page-search">
            <div class="container">
                <h3 class="faq-page-search__title">Search Your <span>Questions</span><br> Queries here</h3><!-- /.faq-page-search__title -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-one__content">
                            <div class="faq-one--page__image">
                                <img src="assets/images/resources/faq-page-1.jpg" alt="ienet">
                            </div>
