...
<head>
    ...
    <title>Ella L. Albers || Team Details || Ienet || HTML Template For Broadband TV & Internet</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Ella L. Albers</h2><!-- /.page-title -->
                <ul class="ienet-breadcrumb list-unstyled">
                    <li><a href="index.php">Home</a></li>
                    <li>Our Team</li>
                    <li><span>Ella L. Albers</span></li>
        ...
        <section class="team-details">
            <div class="container">
                <div class="team-details__inner">
                    <div class="team-details__inner__bg" style="background-image: url(assets/images/shapes/team-details-inner-bg.png);"></div>
                    <div class="row gutter-y-30">
                        <div class="col-lg-4">
                            <div class="team-details__image">
                                <img src="assets/images/team/team-d-1.png" alt="aleesha Brown Beauty Expert & Therapist">
                        ...
                        <div class="col-lg-8">
                            <div class="team-details__content">
                                <h3 class="team-details__title">About Me</h3><!-- /.team-details__title -->
                                <!-- /.team-details__designation -->
                                <p class="team-details__text">
                                    onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar. Pellentesque sit amet luctus ante,
                                    ut elementum nisl. Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur elit leo. Curabitur
                                    pellentesque ultrices odio eu pellentesque. Phasellus eget ligula leo. Donec ex eros, tristique ac
                                    sollicitudin eu, congue id sem. Sed sit amet elementum velit, lacinia sollicitudin dolor.
                                </p>
                                <p class="team-details__text">
                                    as well as a board member of their software subsidiary. He is also an avid cook and history buff. You can find him
                                    dining late at night with the chefs of the hotels where he stays during his travels
                                </p>
                                <div class="team-details__sign">
                                    <img src="assets/images/resources/sign.png" alt="ienet">
                                </div>
                                <!-- /.team-details__text -->
                                <ul class="list-unstyled team-details__list">
                                    <li>
                                        <div class="team-details__list__icon"><span class="icon-telephone"></span></div>
                                        <a href="tel:+8801236541020">+88 0123 654 1020</a>
                                    </li>
                                    <li>
                                        <div class="team-details__list__icon"><span class="icon-mail"></span></div>
                                        <a href="mailto:info@ienet.com">info@ienet.com</a>
                                    </li>
                                    <li>
                                        <div class="team-details__list__icon"><span class="icon-maps-and-flags"></span></div>
        ...
        <section class="team-details-info">
            <div class="container">
                <h3 class="team-details-info__title">Personal Information</h3><!-- /.team-details-info__title -->
                <p class="team-details-info__text">
                    ...
                    Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin eu, congue id sem. Sed sit amet elementum velit, lacinia
                    sollicitudin dolor.
                </p><!-- /.team-details-info__text -->
                <p class="team-details-info__text">
                ...
                <div class="team-details-info__area">
                    <h3 class="team-details-info__title">Personal skills</h3><!-- /.team-details-info__title -->
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="team-details-info__progress">
                                <h4 class="team-details-info__progress__title">wifi setup</h4>
                                <div class="team-details-info__progress__bar">
                                    <div class="team-details-info__progress__inner count-bar" data-percent="80%">
                                        <div class="team-details-info__progress__number count-text">80%</div>
                                    </div>
                                </div>
                            </div><!-- /.skills-item -->
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="team-details-info__progress">
                                <h4 class="team-details-info__progress__title">fiber cable line</h4>
                                <div class="team-details-info__progress__bar">
                                    <div class="team-details-info__progress__inner count-bar" data-percent="60%">
                                        <div class="team-details-info__progress__number count-text">60%</div>
                                    </div>
                                </div>
                            </div><!-- /.skills-item -->
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="team-details-info__progress">
                                <h4 class="team-details-info__progress__title">cyber security</h4>
                                <div class="team-details-info__progress__bar">
                                    <div class="team-details-info__progress__inner count-bar" data-percent="70%">
                                        <div class="team-details-info__progress__number count-text">70%</div>
                                    </div>
                                </div>
                            </div><!-- /.skills-item -->
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="team-details-info__progress">
                                <h4 class="team-details-info__progress__title">smart data connectivity</h4>
                                <div class="team-details-info__progress__bar">
                                    <div class="team-details-info__progress__inner count-bar" data-percent="90%">
                                        <div class="team-details-info__progress__number count-text">90%</div>
                                    </div>
                                </div>
                            </div><!-- /.skills-item -->
                        </div>
